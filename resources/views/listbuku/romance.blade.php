                    ...
                    <div class="mdk-drawer-layout__content page">
                        ...
                        <div class="container-fluid page__container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/sebatas-mimpi"><img src="images/stories/romance2.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/sebatas-mimpi">Sebatas Mimpi</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/critical-eleven"><img src="images/stories/romance4.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/critical-eleven">Critical Eleven</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/bad-romance"><img src="images/stories/romance5.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/bad-romance">Bad Romance</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/love-to-hate-you"><img src="images/stories/romance6.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/love-to-hate-you">Love To Hate You</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/one-day-in-december"><img src="images/stories/romance7.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/one-day-in-december">One Day In December</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/i-want-to-eat-your-pancreas"><img src="images/stories/romance1.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/i-want-to-eat-your-pancreas">i Want To Eat Your Pancreas</a></h4>
                                        </div>
                                    </div>
                                </div>
