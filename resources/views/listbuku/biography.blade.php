                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/">The Book Of Almost</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/">Sebatas Mimpi</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/">Sembilu</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/">Critical Eleven</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/">Bad Romance</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/">Love To Hate You</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/">One Day In December</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/">i Want To Eat Your Pancreas</a></h4>
                                        </div>
                                    </div>
                                </div>
                        </div>
