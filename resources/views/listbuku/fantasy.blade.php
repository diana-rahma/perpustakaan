                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/the-magic-library"><img src="images/stories/themagiclibrary.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/the-magic-library">The Magic Library</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/to-kill-a-witch"><img src="images/stories/fantasy-tokillawitch.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/to-kill-a-witch">To Kill A Witch</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/harry-potter"><img src="images/stories/harrypotter.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/harry-potter">Harry Potter</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/tujuh-kelana"><img src="images/stories/tujuhkelana.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/tujuh-kelana">Tujuh Kelana</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/the-queen-of-the-tearling"><img src="images/stories/thequeenofthetearling.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/the-queen-of-the-tearling">The Queen Of The Tearling</a></h4>
                                        </div>
                                    </div>
                                </div>
                        </div>
